...
from models2 import Token_indicator_multitask_se2
...
sys.stdout = Logger("./3_1217se2.txt")
...
def evaluation(sample_dataloader, model, device, tokenizer):
    ...
    for step, batch in enumerate(sample_dataloader):
        ...
        IO_tags = tagssss[0]
        label_tags = tagssss[1]
        #start_tags = tagssss[2]
        #end_tags = tagssss[3]
        stance_tags = tagssss[3]
        s1_pred+=stance_tags.cpu().tolist()
...
def main():
    ...
    if args.train:
        ...
        # Model
        model = Token_indicator_multitask_se2(
        ...
        for epoch in range(args.epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                loss_ote, loss_ts, start_loss, end_loss, stance_loss, argument_t_loss= splits[0], splits[1], splits[2], splits[3], splits[4], splits[5]
                # backward pass
