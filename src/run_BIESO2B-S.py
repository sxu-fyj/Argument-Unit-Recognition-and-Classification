...
from utils import InputFeatures_ote, get_data_with_labels

from models2 import Token_OTE2TS3
...
def training(train_dataloader, model, device, optimizer, scheduler, max_grad_norm):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        batch_input_ids, batch_input_mask, batch_sentence_ids, batch_label_ids, batch_BIEO_label_ids, batch_BIEOstance_label_ids = batch
        ...
        loss = model(
            ...
            BIEOstance_labels=batch_BIEOstance_label_ids,
...
def main():
    ...
    train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_BIEO_label_ids, all_BIEOstance_label_ids)
    ...
    eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_BIEO_label_ids, all_BIEOstance_label_ids)
    ...
    test_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_BIEO_label_ids, all_BIEOstance_label_ids)
