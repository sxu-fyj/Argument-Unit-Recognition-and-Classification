...
#from models2 import Token_pipeline_0313_layer2_attention
# from models2 import Token_pipeline_0314_layer1_crf_b1c1
# from models2 import Token_pipeline_0314_layer1_lstm_crf_b1c1
# from models2 import Token_pipeline_0312_layer1_idcnn_crf

from models2 import Token_pipeline_0301
from models2 import Token_pipeline_0301_perceptron
# from models2 import Token_pipeline_0314_layer1_crf_b1c1
#from models2 import Token_pipeline_0314_layer1_lstm_crf_b1c1
#from models2 import Token_pipeline_0314_layer1_lstm_crf_b1c1_perceptron
#from models2 import Token_pipeline_0312_layer1_idcnn_crf
#from models2 import Token_pipeline_0312_layer1_idcnn_crf_perceptron
...
sys.stdout = Logger("./1_0314_bs+lstm_crf_3loss.txt")
...
def main():
    ...
    if args.train:
        ...
        # Model
        model = Token_pipeline_0301_perceptron(
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                for i in batch_label_ids.cpu().tolist():
                    ...
                    for k in range(len(starts)):
                        ...
                        #print('loss_stance"')
                        #print(loss_stance)
                        loss_stances.append(loss_stance)
                ...
                #print('loss_unified"')
                #print(loss_unified)
                loss_unifieds.append(loss_unified)
                ...
                if step % 200 == 0:
                    ...
                    print()
        import pickle
        with open('loss_log.pkl', 'wb') as fw:
            pickle.dump((loss_otes, loss_stances, loss_unifieds, losss), fw, pickle.HIGHEST_PROTOCOL)
    #################################################################################
