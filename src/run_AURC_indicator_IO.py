...
from utils import InputFeatures_indicator_IO2, get_data_with_labels

from models2 import Token_indicator_multitask3
...
def main():
    ...
    train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_argument_input_ids, all_argument_input_mask, all_argument_segment_ids, all_label_ids, all_IO_label_ids, all_stance_label_ids, all_argument_label_ids)
    ...
    eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_argument_input_ids, all_argument_input_mask, all_argument_segment_ids, all_label_ids, all_IO_label_ids, all_stance_label_ids, all_argument_label_ids)
    ...
    test_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_argument_input_ids, all_argument_input_mask, all_argument_segment_ids, all_label_ids, all_IO_label_ids, all_stance_label_ids, all_argument_label_ids)
    ...
    if args.train:
        ...
        # Model
        model = Token_indicator_multitask3(
        ...
        for epoch in range(args.epochs):
            ...
            for step, batch in enumerate(train_dataloader):
                ...
                loss_ote, loss_ts1, loss_ts2, stance_loss1, stance_loss2, argument_t_loss= splits[0], splits[1], splits[2], splits[3], splits[4], splits[5]
                # backward pass
