...
from utils import InputFeatures_base, get_data_with_labels3
...
sys.stdout = Logger("./3_0304_IDCNN.txt")
...
def training(train_dataloader, model, device, optimizer, scheduler, max_grad_norm):
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        batch_input_ids, batch_input_mask, batch_sentence_ids, batch_label_ids, batch_IO_label_ids = batch
...
def main():
    ...
    train_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_IO_ids)
    ...
    eval_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_IO_ids)
    ...
    test_data = TensorDataset(all_input_ids, all_input_mask, all_segment_ids, all_label_ids, all_IO_ids)
