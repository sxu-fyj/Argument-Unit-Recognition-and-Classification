...
#from models2 import Token_pipeline_0304
...
sys.stdout = Logger("./0_0326_pipeline_Li_cross.txt")
...
def main():
    ...
    # 数据位置
    parser.add_argument('--output_dir', type=str, default='../models_gpu00/',
