...
from models2 import Token_pipeline_0301_dot
#from models2 import Token_pipeline_0314_layer1_lstm_crf_b1c1_dot
#from models2 import Token_pipeline_0312_layer1_idcnn_crf_dot
...
def main():
    ...
    # 数据位置
    parser.add_argument('--output_dir', type=str, default='../models_gpu1111/',
